...
train = True
test = True
filename = 'Results/tracker_ObjectRecognition_4options.pkl'
if new_tracker == True:
    tracker = {}
else:
...
for dataset in ['1_street','2_food']:
    ...
    for i in range(iterations):
        ...
        if 'iter_' + str(i) not in tracker[dataset]:
            ...
            temp = Dense(4, activation='sigmoid')(modelBase.layers[-2].output)
            ...
            weight_path_new = 'Results/'+ dataset +'_4options_Iteration' + str(i)
            ...
            if train == True:
                ...
                logger = CSVLogger('Results/' + dataset + '_4options_Iteration' + str(i) +'.csv')
